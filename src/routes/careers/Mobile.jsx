   ...
   return (
      ...
      >
         ...
         <p className="my-5 note">
            ...
            Systems. The two most popular and widely used operating systems are
            Apple iOS and Google Android OS. Although there are other types of
            mobile devices out there with different kinds of operating systems,
            their percentage is very small compared to these two.
         </p>
         ...
         <p className="my-5 note">
            ...
            operating system. These type of cross platform OS applications are
            called <b>hybrid applications.</b>{" "}
         </p>
